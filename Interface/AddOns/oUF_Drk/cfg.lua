...
--player
    ...
    cfg.playerY = 250 -- y-coordinate of the player frame
--target
    cfg.targetX = 200 -- x-coordinate of the target frame
    cfg.targetY = 250 -- y-coordinate of the target frame
--boss
    cfg.bossX = 0 -- x-coordinate of boss frames
    cfg.bossY = 0 -- y-coordinate is for the first bossframe, additional frames will grow upwards (75px each)
--auras
...
--castbar
    ...
    cfg.playerCastBarX = 11
    cfg.playerCastBarY = 160
    cfg.playerCastBarWidth = 240
    cfg.playerCastBarHeight = 22
    --target
    cfg.targetCastBarOnUnitframe = false
    cfg.targetCastBarX = 11
    cfg.targetCastBarY = 500
    cfg.targetCastBarWidth = 350
    cfg.targetCastBarHeight = 28
--raid&party frames
...
cfg.powerbar_texture = "Interface\\AddOns\\oUF_Drk\\media\\Statusbar"
...
cfg.smallfont = STANDARD_TEXT_FONT
cfg.raidfont = STANDARD_TEXT_FONT
cfg.squarefont = STANDARD_TEXT_FONT
